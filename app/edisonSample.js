...
var myDigitalPin5 = new mraa.Gpio(2); //setup digital read on Digital pin #5 (D5)
...
{
  myDigitalPin5.write(ledState?1:0); //if ledState is true then write a '1' (high) otherwise write a '0' (low)
